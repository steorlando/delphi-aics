...
export async function sendFirstAccessEmail(input: AuthLinkEmailInput) {
  ...
  await sendAppEmail({
    ...
    text: [
      `Gentile ${input.name?.trim() || input.email},`,
      "",
      "nell'ambito del percorso di consultazione Delphi sulla prima versione del documento relativo alle Linee Operative AICS in Salute Globale, e' stato creato per Lei un account di accesso alla piattaforma dedicata.",
      "",
      "La invitiamo a completare il primo accesso cliccando sul pulsante seguente:",
      "",
      "Completa il primo accesso",
      "",
      "Se il pulsante non funziona, puo' copiare e incollare questo link nel browser:",
      input.link,
      "",
      "Qualora non si aspettasse questa comunicazione, puo' ignorare l'email.",
      "",
      "Cordiali saluti",
    ].join("\n"),
    html: [
      `<p>Gentile ${safeName},</p>`,
      "<p>nell'ambito del percorso di consultazione Delphi sulla prima versione del documento relativo alle Linee Operative AICS in Salute Globale, e' stato creato per Lei un account di accesso alla piattaforma dedicata.</p>",
      "<p>La invitiamo a completare il primo accesso cliccando sul pulsante seguente:</p>",
      `<p><a href="${safeLink}">Completa il primo accesso</a></p>`,
      `<p>Se il pulsante non funziona, puo' copiare e incollare questo link nel browser:</p>`,
      `<p>${safeLink}</p>`,
      "<p>Qualora non si aspettasse questa comunicazione, puo' ignorare l'email.</p>",
      "<p>Cordiali saluti</p>",
    ].join(""),
  });
}
